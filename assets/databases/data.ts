...
const DATA: PostType[] = [
  {
    ...
    titulo: "Afrika",
    descripcion:
      "Hoy, noche del mes en Afrika Club, no te la pierdas",
    imagenes: [
    ...
    fechaFin: new Date("2025-11-01T02:00:00") // ejemplo, duracion de 3.5h
  },
  {
    id: "2",
    titulo: "Jazz&Funk Jam",
    descripcion:
      "En Plaza Vicente Lopez va a ver un Jam de musica a las 19:45 hs\nSumate!!",
    imagenes: [
    ...
    fechaFin: new Date("2025-11-02T23:00:00") // ejemplo, 3h15min
  },
  {
    id: "3",
    titulo: "Siga la Vaca, Super promo",
    descripcion:
      "Hoy durante todo el día, promo especial 15% de descuento en Siga la Vaca, cualquier medio de pago!!",
    imagenes: [],
    fechaInicio: new Date("2025-11-03T10:00:00"),
    fechaFin: new Date("2025-11-03T22:00:00") // todo el día
  }
];
